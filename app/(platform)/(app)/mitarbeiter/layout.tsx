...
const STAFF_NAV: readonly ModuleSubnavItem[] = [
  {
    ...
    label: "Übersicht",
    matchMode: "exact",
    activeWhen: ["/mitarbeiter"],
  },
  {
    href: "/mitarbeiter/vertraege",
    label: "Verträge",
    matchMode: "exact",
  },
  {
...
function MitarbeiterLayoutInner({ children }: { children: React.ReactNode }) {
  ...
  const needsStaffPicker =
    pathname.startsWith("/mitarbeiter/vertraege") ||
    pathname.startsWith("/mitarbeiter/arbeitszeiten") ||
    pathname.startsWith("/mitarbeiter/export");
