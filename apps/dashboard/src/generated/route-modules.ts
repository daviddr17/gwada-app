...
const Lazy__dashboard_bewertungen_uebersicht = lazy(() => import("@/components/reviews/reviews-overview-keep-alive-screen").then((m) => ({ default: m.ReviewsOverviewKeepAliveScreen as ComponentType })));
...
const Lazy__dashboard_buchfuehrung_rechnungen = lazy(() => import("@/components/accounting/accounting-invoices-keep-alive-screen").then((m) => ({ default: m.AccountingInvoicesKeepAliveScreen as ComponentType })));
...
const Lazy__dashboard_checklisten = lazy(() => import("@/components/checklisten/checklisten-home-keep-alive-screen").then((m) => ({ default: m.ChecklistenHomeKeepAliveScreen as ComponentType })));
...
const Lazy__dashboard_dokumente_uebersicht = lazy(() => import("@/components/documents/documents-overview-keep-alive-screen").then((m) => ({ default: m.DocumentsOverviewKeepAliveScreen as ComponentType })));
...
const Lazy__dashboard_events_uebersicht = lazy(() => import("@/components/events/events-overview-keep-alive-screen").then((m) => ({ default: m.EventsOverviewKeepAliveScreen as ComponentType })));
...
const Lazy__dashboard_galerie_uebersicht = lazy(() => import("@/components/gallery/gallery-overview-keep-alive-screen").then((m) => ({ default: m.GalleryOverviewKeepAliveScreen as ComponentType })));
const Lazy__dashboard_insights_uebersicht = lazy(() => import("@/components/insights/insights-overview-keep-alive-screen").then((m) => ({ default: m.InsightsOverviewKeepAliveScreen as ComponentType })));
...
const Lazy__dashboard_inventory_uebersicht = lazy(() => import("@/components/inventory/inventory-overview-keep-alive-screen").then((m) => ({ default: m.InventoryOverviewKeepAliveScreen as ComponentType })));
...
const Lazy__dashboard_kontakte_nachrichten = lazy(() => import("@/components/contacts/contacts-messages-keep-alive-screen").then((m) => ({ default: m.ContactsMessagesKeepAliveScreen as ComponentType })));
...
const Lazy__dashboard_news_uebersicht = lazy(() => import("@/components/news/news-overview-keep-alive-screen").then((m) => ({ default: m.NewsOverviewKeepAliveScreen as ComponentType })));
const Lazy__dashboard = lazy(() => import("@/components/dashboard/dashboard-home-screen").then((m) => ({ default: m.DashboardHomeScreen as ComponentType })));
...
const Lazy__dashboard_pos_uebersicht = lazy(() => import("@/components/pos/pos-overview-keep-alive-screen").then((m) => ({ default: m.PosOverviewKeepAliveScreen as ComponentType })));
const Lazy__dashboard_profile_anmeldung = profileLazy(() =>
  import("@/components/profile/profile-anmeldung-screen").then((m) => ({
    default: m.ProfileAnmeldungScreen as ComponentType,
  })),
);
const Lazy__dashboard_profile_arbeitszeiten = profileLazy(() =>
  import("@/components/profile/profile-work-hours-screen").then((m) => ({
    default: m.ProfileWorkHoursScreen as ComponentType,
  })),
);
const Lazy__dashboard_profile_benachrichtigungen = profileLazy(() =>
  import("@/components/notifications/notification-preferences-panel").then(
    (m) => ({ default: m.NotificationPreferencesPanel as ComponentType }),
  ),
);
const Lazy__dashboard_profile_dienstplan = profileLazy(() =>
  import("@/components/profile/profile-shift-plan-screen").then((m) => ({
    default: m.ProfileShiftPlanScreen as ComponentType,
  })),
);
const Lazy__dashboard_profile_display_pin = profileLazy(() =>
  import("@/components/profile/profile-display-pin-screen").then((m) => ({
    default: m.ProfileDisplayPinScreen as ComponentType,
  })),
);
const Lazy__dashboard_profile_dokumente = profileLazy(() =>
  import("@/components/profile/profile-documents-screen").then((m) => ({
    default: m.ProfileDocumentsScreen as ComponentType,
  })),
);
const Lazy__dashboard_profile_persoenliche_daten = profileLazy(() =>
  import("@/components/profile/profile-persoenliche-daten-screen").then(
    (m) => ({ default: m.ProfilePersoenlicheDatenScreen as ComponentType }),
  ),
);
const Lazy__dashboard_profile_verfuegbarkeit = profileLazy(() =>
  import("@/components/profile/profile-availability-screen").then((m) => ({
    default: m.ProfileAvailabilityScreen as ComponentType,
  })),
);
...
const Lazy__dashboard_reservierungen_uebersicht = lazy(() => import("@/components/reservations/reservations-overview-keep-alive-screen").then((m) => ({ default: m.ReservationsOverviewKeepAliveScreen as ComponentType })));
const Lazy__dashboard_settings_abo = settingsLazy(() =>
  import("@/components/settings/restaurant-billing-panel").then((m) => ({
    default: m.RestaurantBillingPanel as ComponentType,
  })),
);
const Lazy__dashboard_settings_api = settingsLazy(() =>
  import("@/components/settings/restaurant-api-keys-panel").then((m) => ({
    default: m.RestaurantApiKeysPanel as ComponentType,
  })),
);
const Lazy__dashboard_settings_dashboard = settingsLazy(() =>
  import("@/components/settings/dashboard-shortcuts-panel").then((m) => ({
    default: m.DashboardShortcutsPanel as ComponentType,
  })),
);
const Lazy__dashboard_settings_integrationen = settingsLazy(() =>
  import("../routes/settings-integrationen-route").then((m) => ({
    default: m.SettingsIntegrationenRoute as ComponentType,
  })),
);
const Lazy__dashboard_settings_displays = settingsLazy(() =>
  import("@/components/settings/restaurant-displays-panel").then((m) => ({
    default: m.RestaurantDisplaysPanel as ComponentType,
  })),
);
const Lazy__dashboard_settings_oeffnungszeiten_einbinden = settingsLazy(() =>
  import("@/components/settings/opening-hours-embed-panel").then((m) => ({
    default: m.OpeningHoursEmbedPanel as ComponentType,
  })),
);
const Lazy__dashboard_settings_oeffnungszeiten = settingsLazy(() =>
  import("@/components/settings/restaurant-settings").then((m) => ({
    default: m.RestaurantSettingsPanel as ComponentType,
  })),
);
const Lazy__dashboard_settings_restaurant = settingsLazy(() =>
  import("@/components/settings/restaurant-settings").then((m) => ({
    default: m.RestaurantSettingsPanel as ComponentType,
  })),
);
const Lazy__dashboard_settings_team = settingsLazy(() =>
  import("@/components/settings/restaurant-team-settings-panel").then((m) => ({
    default: m.RestaurantTeamSettingsPanel as ComponentType,
  })),
);
...
export const DASHBOARD_ROUTE_ENTRIES: DashboardRouteEntry[] = [
  ...
  { path: "/bewertungen/uebersicht", fullPath: "/dashboard/bewertungen/uebersicht", Lazy: Lazy__dashboard_bewertungen_uebersicht },
  ...
  { path: "/buchfuehrung/rechnungen", fullPath: "/dashboard/buchfuehrung/rechnungen", Lazy: Lazy__dashboard_buchfuehrung_rechnungen },
  ...
  { path: "/checklisten", fullPath: "/dashboard/checklisten", Lazy: Lazy__dashboard_checklisten },
  ...
  { path: "/dokumente/uebersicht", fullPath: "/dashboard/dokumente/uebersicht", Lazy: Lazy__dashboard_dokumente_uebersicht },
  ...
  { path: "/events/uebersicht", fullPath: "/dashboard/events/uebersicht", Lazy: Lazy__dashboard_events_uebersicht },
  ...
  { path: "/galerie/uebersicht", fullPath: "/dashboard/galerie/uebersicht", Lazy: Lazy__dashboard_galerie_uebersicht },
  ...
  { path: "/insights/uebersicht", fullPath: "/dashboard/insights/uebersicht", Lazy: Lazy__dashboard_insights_uebersicht },
  ...
  { path: "/inventory/uebersicht", fullPath: "/dashboard/inventory/uebersicht", Lazy: Lazy__dashboard_inventory_uebersicht },
  ...
  { path: "/kontakte/nachrichten", fullPath: "/dashboard/kontakte/nachrichten", Lazy: Lazy__dashboard_kontakte_nachrichten },
  ...
  { path: "/menu/uebersicht", fullPath: "/dashboard/menu/uebersicht", Lazy: Lazy__dashboard_menu_uebersicht },
  ...
  { path: "/mitarbeiter/uebersicht", fullPath: "/dashboard/mitarbeiter/uebersicht", Lazy: Lazy__dashboard_mitarbeiter_uebersicht },
  ...
  { path: "/news/uebersicht", fullPath: "/dashboard/news/uebersicht", Lazy: Lazy__dashboard_news_uebersicht },
  { path: "/", fullPath: "/dashboard", Lazy: Lazy__dashboard },
  ...
  { path: "/pos/uebersicht", fullPath: "/dashboard/pos/uebersicht", Lazy: Lazy__dashboard_pos_uebersicht },
  ...
  { path: "/reservierungen/uebersicht", fullPath: "/dashboard/reservierungen/uebersicht", Lazy: Lazy__dashboard_reservierungen_uebersicht },
