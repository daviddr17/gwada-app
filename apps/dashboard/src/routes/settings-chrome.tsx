...
/** Einstellungen-Modul-Chrome (früher Next layout). */
...
export function wrapSettingsPage(Page: ComponentType): ComponentType {
  function Wrapped() {
    return (
      <SettingsChrome>
        <Page />
  ...
  Wrapped.displayName = `SettingsChrome(${Page.displayName ?? Page.name ?? "Page"})`;
  return Wrapped;
}
