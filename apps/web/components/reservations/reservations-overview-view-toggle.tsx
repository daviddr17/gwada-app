...
import type { ReservationsOverviewViewMode } from "@/lib/hooks/use-reservations-overview-view-mode";

export function ReservationsOverviewViewToggle({
  value,
  onChange,
  disabled,
}: {
  value: ReservationsOverviewViewMode;
  onChange: (next: ReservationsOverviewViewMode) => void;
  disabled?: boolean;
}) {
  return (
    <div
