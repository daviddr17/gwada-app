...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "relative flex min-h-0 w-full flex-1 flex-col overflow-hidden bg-background transition-[margin] duration-300 ease-out md:peer-data-[variant=inset]:mb-2 md:peer-data-[variant=inset]:me-2 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:mt-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:rounded-ss-none md:peer-data-[variant=inset]:shadow-none md:peer-data-[variant=inset]:dark:shadow-sm",
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "cursor-pointer peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm ring-sidebar-ring outline-hidden transition-[height,padding] duration-300 ease-out group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:justify-center! group-data-[collapsible=icon]:gap-0! group-data-[collapsible=icon]:rounded-full! group-data-[collapsible=icon]:p-0! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground data-active:bg-sidebar-accent data-active:font-medium data-active:text-sidebar-accent-foreground [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate group-data-[collapsible=icon]:[&>span:last-child]:hidden",
  {
    variants: {
      variant: {
      ...
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
        lg: "h-14 min-h-14 rounded-lg text-sm group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:min-h-8! group-data-[collapsible=icon]:justify-center! group-data-[collapsible=icon]:gap-0! group-data-[collapsible=icon]:rounded-full! group-data-[collapsible=icon]:p-0!",
      },
    },
    defaultVariants: {
      variant: "default",
