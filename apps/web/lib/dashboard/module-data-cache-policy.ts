...
export const MODULE_DATA_CACHE_REGISTRY: ModuleCachePolicyEntry[] = [
  ...
  },
  {
    ...
    description:
      "Gwada-DB + WAHA/E-Mail/Facebook/Instagram — sessionStorage-Cache (30 Min Session). Öffnen: Cache sofort, Force-Refetch nur wenn älter als 5 Min (SWR); sonst Background-Poll 5 Min + Realtime. Mount app-weit im (app)-Layout.",
    loadTriggers: [
