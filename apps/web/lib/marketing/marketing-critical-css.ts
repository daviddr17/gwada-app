...
@media (max-width:639px){.gwada-hero-blob{filter:blur(48px);will-change:auto}.gwada-hero-blob-c,.gwada-hero-blob-d{display:none}}
...
@media (max-width:639px){.landing-hero-rise-logo,.landing-hero-rise-h1{animation:none}}
