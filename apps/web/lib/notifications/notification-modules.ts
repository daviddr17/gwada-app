...
> = {
  ...
  events_inquiry: {
    id: "events_inquiry",
    label: "Veranstaltungs-Anfrage",
    labelPlural: "Veranstaltungs-Anfragen",
    href: "/dashboard/events/uebersicht?filter=private",
    icon: PartyPopper,
    settingsInAppLabel: "Neue Veranstaltungs-Anfragen in der Glocke",
    settingsPushWhatsappLabel: "WhatsApp bei Veranstaltungs-Anfragen",
    settingsPushEmailLabel: "E-Mail bei Veranstaltungs-Anfragen",
  },
  staff_shift_start: {
