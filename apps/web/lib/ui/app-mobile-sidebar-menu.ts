...
export const appMobileSidebarModuleGroupContentClassName = [
  ...
  "[&_[data-sidebar=menu-button][data-active]]:border-border/50 [&_[data-sidebar=menu-button][data-active]]:bg-accent/10 [&_[data-sidebar=menu-button][data-active]]:shadow-xs",
