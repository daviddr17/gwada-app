-- Bestellungen: Lieferanten-Zeile vor Insert sicherstellen (Live hatte oft nur UI-Seeds, keine inventory_suppliers).
-- Zusätzlich: nur Restaurant-Mitarbeiter dürfen die RPC aufrufen (außer service_role).
