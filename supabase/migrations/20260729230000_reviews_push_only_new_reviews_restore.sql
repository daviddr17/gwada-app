-- Regression-Fix: 20260621160000 hat die Guards aus
-- 20260613195000 überschrieben → jeder Cache-INSERT (auch alte Reviews beim
-- Tiefen-Sync / Cache-Refill) erzeugte notification_events + Push.
-- Guards wiederherstellen: Erst-Sync, fehlendes/altes createdAt, vor prev_synced_at.
...
comment on function public.trg_emit_notification_event_reviews_cache() is
  'Push nur bei neuen externen Bewertungen (createdAt nahe am Sync-Fenster), nicht beim Import/Refill alter Reviews.';
